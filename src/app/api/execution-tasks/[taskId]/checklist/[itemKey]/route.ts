...
type Params = { params: Promise<{ taskId: string; itemKey: string }> };
...
export async function PATCH(req: Request, { params }: Params) {
  ...
  const { taskId, itemKey: rawItemKey } = await params;
  ...
  try {
    ...
    console.error("PATCH EXECUTION TASK CHECKLIST ERROR:", e);
