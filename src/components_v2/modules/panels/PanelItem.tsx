...
export const PanelItem: React.FC<PanelItemProps> = React.memo(
  ({ id, cx, cy, wPx, hPx, rotationDeg, slopeArrowAzimuthDeg, lockSlopeArrowToRoof = false, selected, image, onStartDrag, onSelect, onRoutePointerDown }) => {
