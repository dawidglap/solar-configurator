...
/**
 * NOTE: nonostante il nome, è il pannello “Eigenschaften” dock a SINISTRA,
 * SEMPRE APERTO. La posizione viene gestita dal wrapper in CanvasStage (vedi sotto).
 */
export default function RightPropertiesPanelOverlay() {
  ...
  return (
    <div className="w-[var(--propW,280px)] max-w-[92vw] h-full min-h-0 bg-white/95 border border-neutral-200 shadow-xl flex flex-col overflow-hidden">
      {/* Header minimale, nessun collapse */}
  ...
  const onFileChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = () => {
      ...
      img.onload = () => {
        ...
        clearDetectedRoofs(); // upload non georeferenziato → niente tetti proposti
      };
      img.src = url;
    };
