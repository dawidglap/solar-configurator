...
export default function RightPropertiesPanelOverlay() {
  return (
    <div className="w-[var(--propW,264px)] max-w-[92vw] h-full min-h-0 bg-[#404F5A]/65 backdrop-blur-xl shadow-xl flex flex-col overflow-hidden border-l border-[#7E8B97] rounded-bl-2xl ">
