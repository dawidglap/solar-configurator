...
export default function OverlayRightToggle() {
  ...
  const base = 'pointer-events-auto absolute top-[8px] right-3 z-[300] h-9 px-3 rounded-full border shadow inline-flex items-center gap-2 text-sm transition-colors';
