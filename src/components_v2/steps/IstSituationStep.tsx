      ...
      <div className="h-[calc(100vh-1rem)] overflow-y-auto px-5 py-5 lg:px-7 lg:py-6 space-y-4">
        ...
        <form onSubmit={onNext} className="space-y-5">
          ...
          <div className="grid grid-cols-1 gap-5 lg:grid-cols-[240px_minmax(0,1fr)]">
            {/* ───────────── LEFT: CHECKLISTE ───────────── */}
            <aside className="rounded-2xl bg-white/5 border border-[#7E8B97] backdrop-blur-md px-4 py-4 flex flex-col gap-4">
              <div>
                      ...
                      <button
                        ...
                        className={`flex flex-col items-center gap-2 rounded-xl border px-2 py-3 transition ${
                          active
                            ...
                            : "border-[#7E8B97] bg-white/0 hover:bg-white/5"
                        }`}
                      >
                    ...
                    return (
                      <button
                        ...
                        className={`flex-1 rounded-full border px-3 py-1.5 transition ${
                          active
                            ? "border-emerald-400/80 bg-emerald-500/10"
                            : "border-[#7E8B97] hover:bg-white/5"
                        }`}
                      >
                        {label}
                      </button>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 space-y-2">
                    <select
                      ...
                      value={ist.heating}
                      onChange={(e) =>
                        setIst({ heating: e.target.value as any })
                      }
                    >
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setIst({ heatingCombo: !ist.heatingCombo })
                      }
              ...
              <Card number={9} title="Demontage?">
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setIst({ dismantlingNote: e.target.value })
                    }
                    placeholder="Notiz"
                  />
                </div>
...
function Card({ number, title, children }: CardProps) {
  return (
    <section className="relative rounded-2xl bg-white/5 border border-[#7E8B97] backdrop-blur-md px-4 py-4 flex flex-col gap-3">
